...
Commits are short imperative descriptions (never include version numbers). Each bug fix or feature change should be committed individually (one commit per fix).
